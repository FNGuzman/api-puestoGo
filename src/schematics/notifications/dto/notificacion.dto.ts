...
export class NotificacionDTO extends CommonDTO {
  ...
  @ApiProperty({ description: 'Estado de lectura de la notificación', type: Boolean })
  @Expose()
  leido: boolean;

  @ApiPropertyOptional({ description: 'Fecha de lectura de la notificación', required: false })
  @Expose()
  leidoEn: Date | null;
