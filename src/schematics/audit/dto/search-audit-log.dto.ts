...
export class SearchAuditLogDto extends BaseSearchDto {
  @ApiProperty({ description: 'ID de la auditoría', type: Number, required: false })
  @IsNumber()
  @IsOptional()
  @Type(() => Number)
  id?: number;
  ...
  @ApiProperty({ description: 'Nombre de la entidad', type: String, required: false })
  @IsOptional()
  @IsString()
  entity?: string;

  @ApiProperty({ description: 'ID de la entidad', type: Number, required: false })
  @IsOptional()
  @Type(() => Number)
  entityId?: number;
  ...
  @ApiProperty({ description: 'Ruta de la petición', type: String, required: false })
  @IsOptional()
  @IsString()
  path?: string;

  @ApiProperty({ description: 'ID de la petición', type: String, required: false })
  @IsOptional()
  @IsString()
  requestId?: string;
