...
export class ResetPasswordRequestDto {
  ...
  @ApiProperty({ description: 'Código de 6 dígitos enviado por correo', example: '123456', minLength: 6, maxLength: 6 })
  @IsNotEmpty()
  @IsString()
  @Length(6, 6)
  ...
  @ApiProperty({ description: 'Nueva contraseña', minLength: 6, example: 'nuevaClave123' })
  @IsNotEmpty()
  @IsString()
  @MinLength(6)
  contrasena: string;

  @ApiProperty({ description: 'Repetir la nueva contraseña', minLength: 6, example: 'nuevaClave123' })
  @IsNotEmpty()
  @IsString()
  @MinLength(6)
